...
const LoginSeller = () => {
    ...
    const verifyOtp = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                `${process.env.REACT_APP_API}/api/v1/auth/login-seller`,
                { uid }
            );
    ...
    return (
        <Layout title={'Login - Ecommerce Website'}>
            <div className="loginseller_container">
                <div className="login_content">
                    ...
                    <div className="login_form">
                        ...
                        <div className="divider-container">
                            ...
                            <span className="divider-text">Buying for self?</span>
                            <div className="sellerline"></div>
                        </div>
                        <div className='signin_user'>
                            <button className="user_text" onClick={toUser}>Sign in with user's account</button>
                            <button className="user_icon_btn" onClick={toUser}>
